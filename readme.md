...
Extracting matches for capturing groups are not yet supported, but will be.
Named captures and non-capturing groups are both supported syntax, though
they have no effect, since capturing is not yet supported. Lookahead and
lookbehind are not currently supported. Backreferences are unlikely to ever
be supported.

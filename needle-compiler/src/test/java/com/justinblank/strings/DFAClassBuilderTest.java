    ...
    void indexForwards() {
        try {
            ...
            var builder = new DFAClassBuilder("indexForwards",
                    dfa, dfa, dfaReversed, dfa, dfa, node.bestFactors(), CompilerOptions.defaultOptions(), false);
            builder.initMethods();
    ...
    void indexForwardsSingleChar() {
        try {
            ...
            var builder = new DFAClassBuilder("indexForwardsSingleChar",
                    dfa, dfa, dfa, dfa, dfa, node.bestFactors(), CompilerOptions.defaultOptions(), false);
            builder. initMethods();

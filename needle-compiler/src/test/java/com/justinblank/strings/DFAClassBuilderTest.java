...
class DFAClassBuilderTest {
    ...
    void containedIn() {
        ...
        var builder = new DFAClassBuilder("testContainedIn", dfa,
                dfa, dfa, dfa, factorization, CompilerOptions.defaultOptions(), false);
    ...
    void indexForwards() {
        try {
            ...
            var builder = new DFAClassBuilder("indexForwards",
                    dfa, dfa, dfaReversed, dfa, node.bestFactors(), CompilerOptions.defaultOptions(), false);
            builder.initMethods();
    ...
    void indexForwardsSingleChar() {
        try {
            ...
            var builder = new DFAClassBuilder("indexForwardsSingleChar",
                    dfa, dfa, dfa, dfa, node.bestFactors(), CompilerOptions.defaultOptions(), false);
            builder. initMethods();
    ...
    void stateMethodIsCompilable() throws Exception {
        ...
        var builder = new DFAClassBuilder("testStateMethod",
                dfa, dfa, dfa, dfa, Factorization.fromChar('a'), CompilerOptions.defaultOptions(), false);
        builder.addStateMethods();
